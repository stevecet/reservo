...
export default function AdminLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (
        credentials.email === "admin@Reservo.com" &&
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Access the Reservo admin dashboard
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm font-mono">Email: admin@Reservo.com</p>
