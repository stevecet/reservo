  ...
  const handleRegister = async (
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Welcome to Reservo! Your ${userType} account has been created.`,
      });
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join Reservo and start your journey
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="client" className="w-full">
              ...
              <TabsContent value="client">
                <form
                  onSubmit={(e) => handleRegister(e, "client")}
                  className="space-y-4"
                >
              ...
              <TabsContent value="provider">
                <form
                  onSubmit={(e) => handleRegister(e, "provider")}
                  className="space-y-4"
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
